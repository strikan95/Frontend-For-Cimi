...
function DummyText() {
  return (
    <p className={'flex flex-wrap text-wrap break-words'}>
      FIRST START START START START START START START START START START START
      START Sed ut perspiciatis unde omnis iste natus error sit voluptatem
      ...
      dolorem eum fugiat quo voluptas nulla pariatur? END END END END END END
      END END END END END END LAST
    </p>
  );
}
